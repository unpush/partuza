...
<div id="profileInfo" class="blue">
	Join the party with Partuza!<br /><br />
	Get in touch with your friends and share the fun.
</div>
<div id="profileContentWide">
	...
	<form action="/register" method="post" id="register">
		...
		<div class="form_entry">
			<div class="form_label"><label for="register_email">email</label></div><input type="text" name="register_email" id="register_email" value="<?=isset($_POST['register_email']) ? $_POST['register_email'] : ''?>" />
		</div>
		...
		<div class="form_entry">
			<div class="form_label"><label for="register_first_name">given (first) name</label></div><input type="text" name="register_first_name" id="register_first_name" value="<?=isset($_POST['register_first_name']) ? $_POST['register_first_name'] : ''?>" />
		</div>

		<div class="form_entry">
			<div class="form_label"><label for="register_last_name">family (last) name </label></div><input type="text" name="register_last_name" id="register_last_name" value="<?=isset($_POST['register_last_name']) ? $_POST['register_last_name'] : ''?>" />
		</div>
